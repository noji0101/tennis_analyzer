...
def make_video(camera_id, filename, hrnet_m, hrnet_c, hrnet_j, hrnet_weights, hrnet_joints_set, image_resolution,
    ...
    while True:
        ...
        if save_video:
            if video_writer is None:
                ...
                video_writer = cv2.VideoWriter(f'result/{filename[0:-4]}/output.avi', fourcc, video_framerate, (frame.shape[1], frame.shape[0]))
...
if __name__ == '__main__':
    ...
    parser.add_argument("--hrnet_weights", "-w", help="hrnet parameters - path to the pretrained weights",
                        type=str, default="/home/duser/workspace/tennis_analyzer/data/simple_HRnet/weights/pose_hrnet_w48_384x288.pth")
